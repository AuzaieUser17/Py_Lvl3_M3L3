...
class DB_Manager:
    ...
    def insert_project(self, data):
        sql = """INSERT INTO projects WHERE user_id = ? AND project_id = ?""" # Masukkan kueri SQL yang benar di sini
        self.__executemany(sql, data)
    ...
    def get_projects(self, user_id):
        sql="""SELECT * FROM projects WHERE user_id = ?""" # Masukkan kueri SQL yang benar di sini
    ...
    def update_projects(self, param, data):
        sql = f"""UPDATE projects SET {param} = ? WHERE project_name = ? AND user_id = ?""" # Masukkan kueri SQL yang benar di sini
        self.__executemany(sql, [data]) 


    def delete_project(self, user_id, project_id):
        sql = """DELETE FROM projects WHERE user_id = ? AND project_id = ? """ # Masukkan kueri SQL yang benar di sini
